...
<body  style=" background-color:#F5F7FA;"id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
...
<div class="container">
    ...
    <div style="background-color:f2f3f8;" class="row panel  col-md-7 col-md-offset-3">
        <div class="panel ">
