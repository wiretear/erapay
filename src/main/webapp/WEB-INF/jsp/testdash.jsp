...
"></i> Wallet</a> </li>
                        ...
                        <div class="col-md-2">
                            <li class="hidden-xs"> <a class="active" href="#"><i class="fa fa-money"></i> Add Money</a> </li>
                        </div>
                    </div>
                </header>
            </div>
                        ...
                        <div style="height: 120px; " class="sales report col-md-12">
                            <div  style="margin-top: 2%" class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <h5 style="color: #8492af;">Last transction    <span  style="color: #223a6f"><b>$200000</b></span>  </h5>
                            </div>
                                <div class="col-md-2">
                                    <h5 style="color: #8492af;">Last transction    <span  style="color: #223a6f"><b>$200000</b></span>  </h5>
                                </div>
                                ...
                                <div class="sales report col-md-2 " style="background-color: #0E1A35;">
