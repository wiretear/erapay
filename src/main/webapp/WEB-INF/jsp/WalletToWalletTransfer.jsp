				...
				<div class="panel">
					...
					<div class="panel-body">
						...
						<form:form method="post" modelAttribute="owallettowallet"
							name="wallettowalletform" action="/erapay/executewalletowalletotp">
							<fieldset>
								...
								<div class="form-group col-md-12">
									...
									<form:input type="text" path="walletNarration" class="form-control"
												value="${owallettowallet.walletNarration}" placeholder="Narration"
												required="required" />
								</div>
							...
							<div class="modal-dialog">
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<form:form method="post" modelAttribute="owallettowallet"
												   name="owallettowallet" action="/erapay/executewalletowallet">
											<div class="container">
												<div class="row">
													<div class="col-sm-6">
														<br> <img
