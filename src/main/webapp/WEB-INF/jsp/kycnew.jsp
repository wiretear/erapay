...
<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form"%>
    <%String kycHomeField = (String) session.getAttribute("KYCHOMEFIELD");%>
<!------ Include the above in your HEAD tag ---------->
    <script>
        function call() {
            var  kycHomeField= "<%=kycHomeField%>";
            if(kycHomeField=="LOGIN")
            {
                $(".test").replaceWith("<li class='snowball'><a href='/erapay/home'> Home</a></li>");
            }
        }
...
<nav  id="navid"class="navbar navbar-default">
      ...
      <li  class="test" id="navloginbtn" ><a href="/erapay/login">LOGIN</a></li>
