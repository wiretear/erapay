...
<div class="col-md-5">
                    ...
                    <strong><%out.print(session.getAttribute("SignUpsErrorMessage"));%></strong>
                    </div>
        <div class="row">
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<form:form method="post" modelAttribute="oMenuGenarationForm"
		name="frm" action="/erapay/signupsuccsess">
									...
									<div class="form-group">
										<input type="text" name="phone"  tabindex="1" class="form-control" placeholder="Mobile No">
									</div>
									<div class="form-group">
										<input type="password"  name="password" tabindex="1" id="password" class="form-control" placeholder="Password">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" name="register-submit" id="register-submit" tabindex="4" class="form-control btn btn-register" value="SignUp Now">
											</div>
										</div>
									</div>
									</form:form>
