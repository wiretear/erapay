            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label for="password"><span class="req">* </span> Password</label> 
                   <form:input type="password" path="password" class="form-control inputpass" id="pass1"  required="required" placeholder="Password" minlength="8" maxlength="16" value="${osignUpFormBean.password}"/>
