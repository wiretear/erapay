...
<body>
		...
		<div
			...
			<div style="background-color: #f2f2f2;" class="panel panel-default">
				...
				<h1  style="font-family: Lucida Console, Monaco, monospace"class="panel-title text-center">Menu Master</h1>
				</div>
				<div class="panel-body">
				<form:form name="frm1" method="post"
		modelAttribute="oMenuGenarationForm"
		action="/ecommercemanagment/users/menugenerationsuccsess1">
					<div class="row">
					...
					<div class="row">
						<div class="margin-bottom col-xs-4 form-group">
							<label class="pull-right">GroupId</label>
						</div>
						<div class="margin-bottom col-xs-6 form-group">
					...
					<div id="wrapper" >
							<input  type="submit" class ="button "name="login-submit" id="login-submit"
					 		 value="Search">
                            <input type="button" class ="button" onclick="location.href='/ecommercemanagment/users/search'" value="Clear" >
					</div>
...
<thead>
			...
			<c:forEach var="bo"
				items="${sessionScope['oMenuGenarationListBO'].authorizingList}"
				varStatus="varSt">
				<tr>
					<td ><c:out value="${bo.serialNo}" /></td>
					<td><c:out value="${bo.nodeId}" /></td>
					<td><c:out value="${bo.groupDescription}" /></td>
					<td><a href="#"
						onclick="doSelect('${bo.nodeId}','${bo.groupDescription}')">Select
					</a></td>
				</tr>
			</c:forEach>
		</table>
