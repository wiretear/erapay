            ...
            <div class="col-md-3 text-center">
                <div class="box">
                    <div class="box-content">
                        ...
                        <a type="button" href="/erapay/kycaddressinfo" id="addressbtn" class="btn btn-block btn-primary">ADDRESS</a>
                        <!-- Modal -->
                                            ...
                                            <div class="container-fluid">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <form:input type="text" path="presentCity"
                                                                    ...
                                                                    id="shipAddress" placeholder="City/Town" required="required"/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="checkbox pull-left">
                                                        <label><input type="checkbox" name="sameAsShipping" id="sameAsShipping">Same as above</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
